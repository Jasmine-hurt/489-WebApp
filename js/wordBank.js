const term = "Term";
const fullDefinition = "This is a really hard description!! not really";
const missingWords = ["is", "really", "description"]; // Words to blank out
const distractingWords = ["easy", "descriptor", "medium"]; // Extra incorrect words
